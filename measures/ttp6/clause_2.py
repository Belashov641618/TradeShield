...
__description__ = "Производство товара в России снижается"
...
def check(session:Session, code:int) -> dict[str,Union[str,float,list]]:
    ...
    for production_russia_year in production_russia_years[:2]:
        links.append((production_russia_year.metric.full_name, production_russia_year.source,
                      (now - production_russia_year.updated).total_seconds()))
